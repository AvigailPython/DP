...
namespace MyMachine
{
    public class Stock
    {
        ...
        public Dictionary<eProduct, List<Product>> AllLists { get; set; }
        public Stock()
        {
            ...
            AllLists = new Dictionary<eProduct, List<Product>> {
                ...
                { eProduct.Coffee,new List<Product>()},
                { eProduct.Coco,new List<Product>()},
                { eProduct.Cappucino,new List<Product>()},
                { eProduct.BlackCoffee,new List<Product>()}
